...
variable {G : Mon 𝒞}
variable {H : Mon 𝒞} [IsCommMonObj H.X]
  ...
  add f g := {
    ...
    isMonHom_hom := {
      one_hom := by
        ...
        rw[this]
        have this₀ : (λ_ (𝟙_ 𝒞)).inv ≫ (𝟙 (𝟙_ 𝒞) ⊗ₘ η[H.X]) ≫ (λ_ H.X).hom = η[H.X] := by
          simp only [id_tensorHom, id_whiskerLeft, IsMonHom.one_hom, Category.assoc,
            Iso.inv_hom_id_assoc]
        have this₁ : (𝟙 (𝟙_ 𝒞) ⊗ₘ η[H.X]) ≫ (η[H.X] ⊗ₘ 𝟙 H.X) = η[H.X] ⊗ₘ η[H.X] := by
          ext
          · have : (η[H.X] ⊗ₘ (𝟙 H.X)) ≫ fst H.X H.X = (fst (𝟙_ 𝒞) H.X) ≫ η[H.X] :=
              tensorHom_fst η (𝟙 H.X)
            rw[Category.assoc, this, ← Category.assoc]
            have : ((𝟙 (𝟙_ 𝒞) ⊗ₘ η[H.X]) ≫ fst (𝟙_ 𝒞) H.X)
                = (fst (𝟙_ 𝒞) (𝟙_ 𝒞)) ≫ 𝟙 (𝟙_ 𝒞) :=
              tensorHom_fst (𝟙 (𝟙_ 𝒞)) η
            rw[this, Category.assoc]
            simp only [Category.id_comp, tensorHom_fst]
          · have : (η[H.X] ⊗ₘ (𝟙 H.X)) ≫ snd H.X H.X = (snd (𝟙_ 𝒞) H.X) ≫ 𝟙 H.X :=
              tensorHom_snd η (𝟙 H.X)
            rw[Category.assoc, this, ← Category.assoc]
            have : ((𝟙 (𝟙_ 𝒞) ⊗ₘ η[H.X]) ≫ snd (𝟙_ 𝒞) H.X)
                = (snd (𝟙_ 𝒞) (𝟙_ 𝒞)) ≫ η[H.X] :=
              tensorHom_snd (𝟙 (𝟙_ 𝒞)) η
            rw[this, Category.assoc]
            simp only [Category.comp_id, tensorHom_snd]
        have : (λ_ (𝟙_ 𝒞)).inv ≫ (η[H.X] ⊗ₘ η[H.X]) = lift η[H.X] η[H.X] := by
      ...
      mul_hom := by
        ...
        have big_this : (α_ H.X H.X (H.X ⊗ H.X)).hom ≫ ((𝟙 H.X) ⊗ₘ (α_ H.X H.X H.X).inv) ≫
          ...
          have : ((𝟙 H.X) ⊗ₘ (α_ H.X H.X H.X).inv) ≫ ((𝟙 H.X) ⊗ₘ μ[H.X] ⊗ₘ (𝟙 H.X)) ≫
            ...
            ext <;> simp
          rw[this]
          simp only [tensorHom_id, MonObj.mul_assoc, Iso.inv_hom_id_assoc,
            MonoidalCategory.whiskerLeft_comp, Category.assoc]
          have : H.X ◁ μ ≫ μ = (α_ H.X H.X H.X).inv ≫ (μ ▷ H.X) ≫ μ := by simp
          rw[this]
          have : (α_ H.X H.X (H.X ⊗ H.X)).hom ≫ H.X ◁ H.X ◁ μ ≫ (α_ H.X H.X H.X).inv ≫ μ ▷ H.X ≫
              μ = ((α_ H.X H.X (H.X ⊗ H.X)).hom ≫ H.X ◁ H.X ◁ μ ≫
            ...
            · have : ((α_ H.X H.X (H.X ⊗ H.X)).hom ≫ H.X ◁ H.X ◁ μ ≫
              ...
              have : ((H.X ⊗ H.X) ◁ μ ≫ μ ▷ H.X) = μ ⊗ₘ μ := by
                have : ((H.X ⊗ H.X) ◁ μ ≫ μ ▷ H.X) = ((𝟙 (H.X ⊗ H.X)) ≫ μ) ⊗ₘ (μ ≫ (𝟙 (H.X))) := by
                  ...
                  have {U V W X Y Z : 𝒞} (φ₁ : U ⟶ W) (φ₂ : V ⟶ X) (ψ₁ : W ⟶ Y)
        ...
        have : (lift f.hom g.hom ⊗ₘ lift f.hom g.hom) ≫
            ...
            (α_ H.X H.X H.X).inv) ≫ ((𝟙 H.X) ⊗ₘ ((β_ H.X H.X).hom ≫ μ) ⊗ₘ (𝟙 H.X))) ≫ (𝟙 H.X ⊗ₘ
            μ) ≫ μ := by
          simp only [id_tensorHom, IsCommMonObj.mul_comm, tensorHom_id, Category.assoc]
        rw[this, ← THIS]
        have : (lift (f.hom ⊗ₘ f.hom) (g.hom ⊗ₘ g.hom) ≫ (α_ H.X H.X (H.X ⊗ H.X)).hom ≫
        ...
        have this' : (((α_ H.X H.X (H.X ⊗ H.X)).hom ≫ (𝟙 H.X ⊗ₘ (α_ H.X H.X H.X).inv) ≫ (𝟙 H.X ⊗ₘ
            μ ⊗ₘ 𝟙 H.X)) ≫ (𝟙 H.X ⊗ₘ μ) ≫ μ) = (α_ H.X H.X (H.X ⊗ H.X)).hom ≫ ((𝟙 H.X) ⊗ₘ
